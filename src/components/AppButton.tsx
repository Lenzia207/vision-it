...
export default function AppButton({ btnText, packageName, fullWidth = false }: AppButtonProps) {
  ...
  const anchorBase =
    "group relative items-center justify-center px-8 py-3.5 text-base font-medium text-white bg-blue-600 rounded-full overflow-hidden transition-all hover:bg-blue-500 hover:scale-105 active:scale-95 shadow-lg shadow-blue-500/25";
